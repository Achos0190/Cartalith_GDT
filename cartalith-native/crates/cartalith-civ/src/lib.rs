...
pub struct Continent {
    ...
    pub id: i32,
    /// Generated by [`civ_settle_name`] in the **default** naming culture
    /// ([`civ_default_culture`]) of the faction holding the most cells on
    /// this landmass -- not a roster-edited one, which settlement naming
    /// reads ([`civ_faction_culture`]) and this function is never handed.
    /// The reference has no separate
