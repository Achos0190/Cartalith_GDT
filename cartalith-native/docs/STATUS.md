...
**Group total: 10 — 7 done (MM-7 verified 2026-09-24), 1 declined, 2 not started.** Corrected 2026-09-24: this line still said "6 done, 4 declined" after Ruling AW reopened MM-6/7/8.
...
Seven rows, all unbuilt. **Proposed 2026-09-25; scheduled by the owner
2026-09-26** as `OUTSTANDING_WORK.md` §2.12. What exists is the
