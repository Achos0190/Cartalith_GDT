...
**Not started**: 2 pack ZIP read/write · 3 scatter rules (with their real
v1.27 hardening against untrusted project input) · 4 rule-driven icon
placement (`placeMapIconsRuled`, first cross-crate dependency, first real
