...
**Not started**: 2 pack ZIP read/write · 4 rule-driven icon
placement (`placeMapIconsRuled`, first real placement
golden-parity surface) · 5 the Library model (`AssetDB`/collections/metadata/
