...
- **Do not edit `reference/Cartalith Gen1 v2.10.html`.** It is the frozen
  ...
  **The freeze has drifted, and the old "no drift" note here was wrong.** This
  ...
  - **Resolved 2026-09-17 — the root v2.11 is a copy the source has long since
    ...
    **51** DCC-line files, newest **v2.73** (counted 2026-09-20). The port is measured against a
  ...
  - **The interval is specified, not unknown.** `RC_ENGINE_CHANGES.md` covers
    v2.11 → v2.73 change by change. Until 2026-09-17 nothing referenced it but
...
| `MAP_CONTEXT_SCOPE.md` | **a proposal, 2026-09-25, not scheduled**: the right-click context card, an 8-slot tool ring per domain, and their tablet and phone forms. Five owner forks; F1 settles a gesture collision between `spec/06-phone.md` (long-press = sample pin) and the shipped code (long-press = context menu). Interactive prototype in `design/map-context-2026-09-25/` |
