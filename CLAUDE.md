...
| `MAP_CONTEXT_SCOPE.md` | **a proposal, 2026-09-25, not scheduled**: the right-click context card, an 8-slot tool ring per domain, and their tablet and phone forms. Five owner forks; F1 settles a gesture collision between `spec/06-phone.md` (long-press = sample pin) and the shipped code (long-press = context menu) |
