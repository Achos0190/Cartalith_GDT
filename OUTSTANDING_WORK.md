...
**116 outstanding items** — 2026-09-20, after closing the PLAN header stale-on-isolate row (`f493b61`); 117 immediately before that, after closing EF-3 (`794802d`; erosion-consistent tile detail, verified with a conditional/honest result — see its row); 118 before that. Previously 120 in one run of
