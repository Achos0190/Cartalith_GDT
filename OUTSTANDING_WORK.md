...
**129 outstanding items** — re-derived mechanically 2026-09-12, by one run of
the counting script.
...
same day filed one unrowed defect, then the seven rows owner Rulings H-K opened , two from that evening’s batch and two from a left-rail inventory — less one row found already built that evening, plus one pre-existing bug a verifier found; on 2026-09-13 the owner’s left-rail re-sort opened one row and absorbed two. The parity audit and the first on-glass pass opened
