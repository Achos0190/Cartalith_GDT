...
`git status` confirms scope. Commit `3a9c5cc`. **Batch F (Generation rules window — the real engine
change) remains**, the last of the six; this row stays open until it lands. |
