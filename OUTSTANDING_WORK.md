...
**91 outstanding items** — re-derived mechanically 2026-09-06, **after
sweeping 23 closed rows out of the numbered sections.**
...
closing four items and opening none still moved the number up. It read 114 with
91 genuinely open. The closed rows now live under **Closed rows, kept for the
