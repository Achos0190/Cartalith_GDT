...
2. **§2.9's three rows hide a survey, not an estimate.** `RC_ENGINE_CHANGES.md`
   specifies **27 distinct engine items** across v2.11–v2.52; how many are
...
from **v2.11 to v2.52**, and until this pass **no document in this repository
...
(newest **v2.22**) and **30** DCC-line files (newest **v2.52**), while
