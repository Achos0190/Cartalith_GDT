...
same day filed one unrowed defect, then the seven rows owner Rulings H-K opened , two from that evening’s batch and two from a left-rail inventory. The parity audit and the first on-glass pass opened
