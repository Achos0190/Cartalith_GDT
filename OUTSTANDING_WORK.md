...
2. **§2.9's three rows hide a survey, not an estimate.** `RC_ENGINE_CHANGES.md`
   specifies **38 distinct engine items** across v2.11–v2.64: 27 through v2.52,
...
from **v2.11 to v2.64**, and until this pass **no document in this repository
...
(newest **v2.22**) and **42** DCC-line files (newest **v2.64**), while
