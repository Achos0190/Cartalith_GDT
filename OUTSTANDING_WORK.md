...
**109 outstanding items** — 2026-09-21, after closing LOD-D5 (`c685930`; scale-aware shading and
hydrology, 2 of 3 bars met, 1 needing an owner ruling on `add_zoom_detail`'s octave decay — see its
row). 110 immediately before, after closing the seven uncalled `cartalith-gpu` public
