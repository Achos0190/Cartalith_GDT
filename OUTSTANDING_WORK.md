...
**119 outstanding items** — re-derived mechanically 2026-09-12, by one run of
the counting script.
...
18 while the rows beneath it were kept current** — 118 live when found, and the
same sweep filed one more. The parity audit and the first on-glass pass opened
